  ...
  useEffect(() => {
    const fetchVehicles = async () => {
      const data = [
        ...
        { id: 2, make: "Tesla", model: "Model S", year: 2020, price: 45, image: "https://static1.topspeedimages.com/wordpress/wp-content/uploads/2023/06/tesla-model-s-plaid-2.jpg" },
        { id: 3, make: "Tesla", model: "Model 3", year: 2021, price: 40, image: "https://www.tesla.com/ownersmanual/images/GUID-B5641257-9E85-404B-9667-4DA5FDF6D2E7-online-en-US.png" },
        { id: 4, make: "Tesla", model: "Model X", year: 2022, price: 70, image: "https://images.prismic.io/carwow/c340a77d-af56-4562-abfb-bd5518ccb292_2023+Tesla+Model+X+front+quarter+moving.jpg" },
        { id: 5, make: "Tesla", model: "Model Y", year: 2023, price: 80, image: "https://images.hgmsites.net/lrg/2022-tesla-model-y-performance-awd-angular-front-exterior-view_100833533_l.jpg" },
      ];
      setVehicles(data);
